...
double responsiveSize(
  ...
  if(isDisplayDesktop(context)){
      ...
      else if(MediaQuery.of(context).size.width <= 1023 || MediaQuery.of(context).size.width >= 600){
        return sm ?? (md ?? xs);
      }
      else if(MediaQuery.of(context).size.width <= 1439 || MediaQuery.of(context).size.width >= 1024){
        return md ?? lg;
      }
      else if(MediaQuery.of(context).size.width <= 1919 || MediaQuery.of(context).size.width >= 1440){
        return lg;
      }
